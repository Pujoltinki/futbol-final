...
const rows = [
  Fecha1('27/04/2024', "08:10", "Real fenix"  , "vs", "Inba"       ),
  Fecha1('27/04/2024', "08:10", "Aeronautica" , "vs", "Alianza"    ),
  Fecha1('27/04/2024', "09:20", "Danton"      , "vs", "Drivers U." ),
  Fecha1('27/04/2024', "09:20", "Feldman"     , "vs", "U.Catolica" ),
];

export default function CustomizedTables() {
  return (
    <Grid className="grisCuadro">
      <h2 style={{ textAlign: 'center' }}>Partidos fecha 5</h2>
