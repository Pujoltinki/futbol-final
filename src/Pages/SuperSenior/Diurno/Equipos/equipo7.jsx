...
//Imagenes
import UCatolica                 from '../../../../imagenes/Equipos/SuperSenior/Diurno/U_Catolica.jpg';
const images = [UCatolica];
...
export default function CollapsibleTable() {
  return (
    ...
    <h2 style={{ textAlign: 'center' }}>Jugadores de Universidad Catolica</h2>
      ...
      {images.map((image, index) => (
        <ImageListItem key={index}>
          ...
          {/* <Grid style={{ display: "flex", justifyContent: "center" }}>
            <img src={UCatolica} alt="" style={{ width: "40%" }}/>
          </Grid>
