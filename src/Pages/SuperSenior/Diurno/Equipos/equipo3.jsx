...
//Imagenes
import RFenix                 from '../../../../imagenes/Equipos/SuperSenior/Diurno/Real_Fenix.jpg';
const images = [RFenix];
...
export default function CollapsibleTable() {
  return (
    ...
    <h2 style={{ textAlign: 'center' }}>Jugadores del Real fenix</h2>
      ...
      {images.map((image, index) => (
        <ImageListItem key={index}>
          ...
          {/* <Grid style={{ display: "flex", justifyContent: "center" }}>
            <img src={RFenix} alt="" style={{ width: "40%" }}/>
          </Grid>
