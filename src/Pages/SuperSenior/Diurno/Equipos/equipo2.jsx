...
//Imagenes
import Feldman                 from '../../../../imagenes/Equipos/SuperSenior/Diurno/Feldman.jpg';
const images = [Feldman];
...
export default function CollapsibleTable() {
  return (
    ...
    <h2 style={{ textAlign: 'center' }}>Jugadores de Feldman</h2>
      ...
      {images.map((image, index) => (
        <ImageListItem key={index}>
          ...
          {/* <Grid style={{ display: "flex", justifyContent: "center" }}>
            <img src={Feldman} alt="" style={{ width: "40%" }}/>
          </Grid>
