...
//Imagenes
import Aeronautica            from '../../../../imagenes/Equipos/SuperSenior/Diurno/Aeronáutica.jpg';
const images = [Aeronautica];
...
export default function CollapsibleTable() {
  return (
    ...
    <h2 style={{ textAlign: 'center' }}>Jugadores de Aeronautica</h2>
      ...
      {images.map((image, index) => (
        <ImageListItem key={index}>
          ...
          {/* <Grid style={{ display: "flex", justifyContent: "center" }}>
            <img src={Aeronautica} alt="" style={{ width: "40%" }}/>
          </Grid>
