...
//Imagenes
import DriversU                 from '../../../../imagenes/Equipos/SuperSenior/Diurno/Drivers.jpg';
const images = [DriversU];
...
export default function CollapsibleTable() {
  return (
    ...
    <h2 style={{ textAlign: 'center' }}>Jugadores de Drivers U.</h2>
      ...
      {images.map((image, index) => (
        <ImageListItem key={index}>
          ...
          {/* <Grid style={{ display: "flex", justifyContent: "center" }}>
            <img src={DriversU} alt="" style={{ width: "40%" }}/>
          </Grid>
