    ...
    <Box sx={{ width: '100%', typography: 'body1' }}>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'center' }}>
        <TabList onChange={handleChange} aria-label="lab API tabs example" variant="scrollable" scrollButtons allowScrollButtonsMobile>
            <Tab label='Danton'      value="1" />
            <Tab label='Feldman'     value="2" />
            <Tab label='Real fenix'  value="3" />
            <Tab label='Drivers U.'  value="4" />
            <Tab label='Aeronautica' value="5" />
            <Tab label='Inba'        value="6" />
            <Tab label='U.Catolica'  value="7" />
            <Tab label='Alianza'     value="8" />
        </TabList>
      </Box>
