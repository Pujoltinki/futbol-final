...
const rows = [
  createData('aaaas 1', 4, 8, 5, 2, 4, 8, 5, 2),
  createData('Equipo 2', 5, 2, 8, 1, 4, 8, 5, 2),
  createData('Equipo 3', 8, 3, 7, 3, 4, 8, 5, 2),
  createData('Equipo 4', 9, 0, 2, 7, 4, 8, 5, 2),
  createData('Equipo 5', 9, 0, 2, 7, 4, 8, 5, 2),
  createData('Equipo 6', 9, 0, 2, 7, 4, 8, 5, 2),
  createData('Equipo 7', 9, 0, 2, 7, 4, 8, 5, 2),
  createData('Equipo 8', 9, 0, 2, 7, 4, 8, 5, 2),
];
