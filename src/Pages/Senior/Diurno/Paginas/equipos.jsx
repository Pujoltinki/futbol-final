    ...
    <Box sx={{ width: '100%', typography: 'body1' }}>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'center' }}>
        <TabList onChange={handleChange} aria-label="lab API tabs example" variant="scrollable" scrollButtons allowScrollButtonsMobile>
            <Tab label='Awkan'           value="1" />
            <Tab label='Makinones'       value="2" />
            <Tab label='J.Brasilia'      value="3" />
            <Tab label='Sanchez e hijos' value="4" />
            <Tab label='Danton'          value="5" />
            <Tab label='Lobos'           value="6" />
            <Tab label='Los Quesos'      value="7" />
            <Tab label='Mosacate'        value="8" />
        </TabList>
      </Box>
