...
const rows = [
  createData('Awkan'           , 0, 0),
  createData('Danton'          , 0, 1),
  createData('J.Brasilia'      , 0, 0),
  createData('Lobos'           , 0, 0),
  createData('Los quesos'      , 0, 0),
  createData('Makinones'       , 0, 0),
  createData('Mosacate'        , 0, 0),
  createData('Sanchez e hijos' , 0, 0),
];
