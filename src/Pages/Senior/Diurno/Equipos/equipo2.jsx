...
//Imagenes
import Makinones                 from '../../../../imagenes/Equipos/Senior/Diurno/Makinones.jpg';
const images = [Makinones];
...
export default function CollapsibleTable() {
  return (
    ...
    <h2 style={{ textAlign: 'center' }}>Jugadores de Makinones</h2>
      ...
      {images.map((image, index) => (
        <ImageListItem key={index}>
          ...
          {/* <Grid style={{ display: "flex", justifyContent: "center" }}>
            <img src={Makinones} alt="" style={{ width: "70%" }}/>
          </Grid> */}
