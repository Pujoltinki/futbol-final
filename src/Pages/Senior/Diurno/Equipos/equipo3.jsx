...
//Imagenes
import JBrasilia                 from '../../../../imagenes/Equipos/Senior/Diurno/J.Brasilia.jpg';
const images = [JBrasilia];
...
export default function CollapsibleTable() {
  return (
    ...
    <h2 style={{ textAlign: 'center' }}>Jugadores de J.Brasilia</h2>
      ...
      {images.map((image, index) => (
        <ImageListItem key={index}>
          ...
          {/* <Grid style={{ display: "flex", justifyContent: "center" }}>
            <img src={JBrasilia} alt="" style={{ width: "70%" }}/>
          </Grid> */}
