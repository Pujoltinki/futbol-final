...
//Imagenes
import SánchezEHijos                 from '../../../../imagenes/Equipos/Senior/Diurno/SánchezEHijos.jpg';
const images = [SánchezEHijos];
...
export default function CollapsibleTable() {
  return (
    ...
    <h2 style={{ textAlign: 'center' }}>Jugadores de Sanchez e hijos</h2>
      ...
      {images.map((image, index) => (
        <ImageListItem key={index}>
          ...
          {/* <Grid style={{ display: "flex", justifyContent: "center" }}>
            <img src={SánchezEHijos} alt="" style={{ width: "70%" }}/>
          </Grid> */}
