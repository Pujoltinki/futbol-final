...
//Imagenes
import Mosacate                 from '../../../../imagenes/Equipos/Senior/Diurno/Mosacate.jpg';

const images = [Mosacate];
...
export default function CollapsibleTable() {
  return (
    ...
    <h2 style={{ textAlign: 'center' }}>Jugadores de Mosacate</h2>
          {/* <Grid style={{ display: "flex", justifyContent: "center" }}>
            <img src={Mosacate} alt="" style={{ width: "70%" }}/>
          </Grid> */}
