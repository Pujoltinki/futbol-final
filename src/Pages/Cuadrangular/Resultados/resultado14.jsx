...
const rows = [
  // Datos principales
  createData('Partido 1', 'Equipo 1 (5)', 'vs', 'Equipo 2 (0)', 'Ganador (Equipo 1)', [
    {
  ...
  createData('Partido 2', 'Equipo 3 (3)', 'vs', 'Equipo 4 (7)', 'Empate', [
    {
  ...
  createData('Partido 3', 'Equipo 1 (5)', 'vs', 'Equipo 2 (0)', 'Ganador (Equipo 1)', [
    {
      // Detalles de la tablas
      accion: 'Falta (Tarjeta roja)',
      equipo: 'Equipo 1',
  ...
  createData('Partido 4', 'Equipo 3 (3)', 'vs', 'Equipo 4 (7)', 'Ganador (Equipo 4)', [
    {
      accion: 'Falta (Tarjeta amarilla)',
      equipo: 'equipo 4',
      jugador: 'Jugador 7',
  ...
  return (
    <Grid>
      <Grid className="grisCuadro">
        <h2 style={{ textAlign: 'center' }}>Resultados fecha 14</h2>
